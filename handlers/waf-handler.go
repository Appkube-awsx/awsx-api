...
import (
	...
	"github.com/Appkube-awsx/awsx-waf/controller"
	"net/http"
)

func GetWaf(w http.ResponseWriter, r *http.Request) {
	log.Info("Starting /awsx/waf api")
	...
	if vaultUrl != "" {
		...
		result, respErr := controller.GetWafWebAcl(clientAuth)
		if respErr != nil {
