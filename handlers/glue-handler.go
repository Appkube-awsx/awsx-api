...
import (
	...
	"github.com/Appkube-awsx/awsx-glue/controller"
	"net/http"
)

func GetGlue(w http.ResponseWriter, r *http.Request) {
	log.Info("Starting /awsx/glue api")
	...
	if vaultUrl != "" {
		...
		result, respErr := controller.GetGlue(clientAuth)
		if respErr != nil {
