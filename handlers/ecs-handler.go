...
import (
	...
	"github.com/Appkube-awsx/awsx-ecs/controller"
	"net/http"
)

func GetEcs(w http.ResponseWriter, r *http.Request) {
	log.Info("Starting /awsx/ecs api")
	...
	if vaultUrl != "" {
		...
		result, respErr := controller.GetEcsClusters(clientAuth)
		if respErr != nil {
