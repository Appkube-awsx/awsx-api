...
func GetNLBNewFlowCountTLSPanel(w http.ResponseWriter, r *http.Request) {
	...
	if clientAuth != nil {
		...
		jsonString, cloudwatchMetricData, err := NLB.GetNLBNewFlowCountTLSPanel(cmd, clientAuth, cloudwatchClient)
		if err != nil {
