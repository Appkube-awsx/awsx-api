...
func GetNLBProcessedBytesPanel(w http.ResponseWriter, r *http.Request) {
	...
	if clientAuth != nil {
		...
		jsonString, cloudwatchMetricData, err := NLB.GetNLBProcessedBytesPanel(cmd, clientAuth, cloudwatchClient)
		if err != nil {
