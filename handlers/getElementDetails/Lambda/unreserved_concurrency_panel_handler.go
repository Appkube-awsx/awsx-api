...
func GetUnreservedConcurrencyPanel(w http.ResponseWriter, r *http.Request) {
	fmt.Print("HERE HERE")
	...
	if clientAuth != nil {
		...
		_, cloudwatchMetricData, err := Lambda.GetLambdaUnreservedConcurrencyCommmand(cmd, clientAuth, lambdaClient)
		if err != nil {
