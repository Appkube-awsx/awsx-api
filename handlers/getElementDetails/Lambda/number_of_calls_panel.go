...
func GetNumberOfCallsPanel(w http.ResponseWriter, r *http.Request) {
	...
	if clientAuth != nil {
		...
		jsonString, cloudwatchMetricData, err := Lambda.GetLambdaNumberOfCallsPanel(cmd, clientAuth, cloudwatchClient)
		if err != nil {
