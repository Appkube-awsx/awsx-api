...
func GetEKSStorageUtilizationPanel(w http.ResponseWriter, r *http.Request) {
	...
	if authFlag {
		...
		jsonString, cloudwatchMetricData, err := EKS.GetStorageUtilizationPanel(cmd, clientAuth,nil)
		if err != nil {
