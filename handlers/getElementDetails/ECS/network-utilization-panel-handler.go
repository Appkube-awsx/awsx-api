...
func GetECSNetworkUtilizationPanel(w http.ResponseWriter, r *http.Request) {
	...
	if authFlag {
		...
		jsonString, cloudwatchMetricData, err := ECS.GetNetworkUtilizationPanel(cmd, clientAuth, nil)
		if err != nil {
