...
func GetECScpuUtilizationPanel(w http.ResponseWriter, r *http.Request) {
	...
	if clientAuth != nil {
		...
		jsonString, cloudwatchMetricData, err := ECS.GetECScpuUtilizationPanel(cmd, clientAuth, cloudwatchClient)
		if err != nil {
