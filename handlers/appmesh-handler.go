...
import (
	...
	"github.com/Appkube-awsx/awsx-appmesh/controller"
)

func GetAppmesh(w http.ResponseWriter, r *http.Request) {
	log.Info("Starting /awsx/appmesh api")
	...
	if vaultUrl != "" {
		...
		result, respErr := controller.GetAppmesh(clientAuth)
		if respErr != nil {
	...
	log.Info("/awsx/appmesh completed")
