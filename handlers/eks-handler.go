...
import (
	...
	"github.com/Appkube-awsx/awsx-eks/controller"
	"net/http"
)

func GetEks(w http.ResponseWriter, r *http.Request) {
	log.Info("Starting /awsx/eks api")
	...
	if vaultUrl != "" {
		...
		result, respErr := controller.GetEksClusters(clientAuth)
		if respErr != nil {
