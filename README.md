...
| 3    | getElementDetails | Collect Information about specific cloud elements -Run Queries | Percentage(%), Bytes                               | 1. EC2, 2. EKS, 3. ECS, 4. LAMBDA, 5. API Gw, 6. Load Balancer  |    [https://github.com/Appkube-awsx/awsx-api/tree/main/specs/allDetailsFile](https://github.com/Appkube-awsx/awsx-api/tree/main/specs/allDetailsFile)   |
